...
conformal = conformal_interval(df, coverage=0.9)
conformal.to_csv(artifacts / "conformal_intervals.csv", index=False)
...
print(f"conformal_coverage={conformal['covered'].mean():.4f}")
print(f"conformal_radius_wh={conformal.attrs['radius_wh']:.2f}")
